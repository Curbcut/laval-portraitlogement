...
start_market_min_max <- 
  ...
  filter(year >= 1992) |> 
  summarize(
    owner_max = convert_number(max(value_trend[market == "Homeowner"])),
    owner_year = year[value_trend == max(value_trend[market == "Homeowner"])],
    condo_max = convert_number(max(value_trend[market == "Condo"])),
    condo_year = year[value_trend == max(value_trend[market == "Condo"])],
    rental_max = convert_number(max(value_trend[market == "Rental"])),
