...
As the Laval population changes over time, the population's housing needs will change as well. While many aspects of this change are not amenable to modelling and to setting targets, one 


A clearly observable trend over the last twenty years in Laval has been an increase in one-person households. 
