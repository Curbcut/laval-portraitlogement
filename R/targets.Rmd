...
This gives us expected average construction times for different building types for each year in the study period. But to model the distribution of construction times properly, we also need some measure of the variance of construction times. While CMHC does not release building-level data, we use census-tract level figures on average construction times as a plausible proxy.
