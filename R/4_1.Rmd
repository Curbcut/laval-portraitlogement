...
Alors que Laval dans son ensemble devrait connaître une croissance de `r pop_growth` entre 2021 et 2041, cette progression démographique ne touchera pas tous les groupes d'âge de manière égale. Les projections indiquent une évolution marquée vers une population plus âgée, avec une augmentation substantielle des personnes de 65 ans et plus. Les groupes des 75 ans et plus, en particulier, connaîtront une forte croissance, tandis que les groupes plus jeunes resteront relativement stables ou afficheront une légère diminution. Ce phénomène s'inscrit dans une tendance plus générale observée à l'échelle du Québec, où le vieillissement de la population représente un enjeu de taille. À Laval, selon les prévisions pour la période 2021-2041, `r growth_attributed_to_65p` de la croissance de la population sera attribuable aux personnes de 65 ans et plus.

```{r plot_4_1_2_3_1, include=TRUE, fig.cap="Projections du nombre d'individus par groupe d'âge de 2021 à 2041", fig.align = 'center'}
plot_4_1_2_3_1
```
