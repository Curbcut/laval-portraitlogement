...
HAVE A WORD ON PROPRIÉTAIRE PAUVRE TKTKTKTK
...
```{r table_4_1_1_2, include=TRUE, fig.cap="Ménages locataires par district électoral. Remarque : les pourcentages concernent le support lui-même", fig.align = 'center'}
table_4_1_1_2
```
