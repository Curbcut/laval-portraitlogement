...
À Laval, la population des personnes âgées de 75 ans et plus, qui constitue le groupe le plus susceptible de résider en résidence privé pour aînés (RPA), s'élève à `r persones_ages` personnes selon les données du dernier recensement canadien, pour `r places_rpa` places en (RPA). La répartition géographique des places en RPA à travers les quartiers électoraux de la ville montre une corrélation modérée avec la population âgée de 75 ans et plus dans chaque quartier, avec un coefficient de corrélation de `r cor_aines_rpa`. Cette corrélation positive suggère que, dans une certaine mesure, les quartiers où l'on trouve plus de personnes âgées offrent également plus de places en RPA. Cependant, des disparités persistent.
...
En 2020, il y avait 4 432 logements sociaux et communautaires dans la ville de Laval. Ces les logements sociaux et communautaire sont ceux dont "la construction est subventionnée par un programme gouvernemental ou municipal. Ces logements s'adressent aux ménages à revenu faible ou modeste ainsi qu'aux citoyens ayant des besoins particuliers en habitation. Ils sont mis en ouvre par des coopératives, par des organismes à but non lucratif et par les Offices municipaux d'habitation, en collaboration avec les groupes de ressources techniques (GRT). Une partie ou la totalité des logements bénéficie d'une aide financière stable couvrant une portion du loyer."

# 5.3.6 Itinérance

_Source: Dénombrement des personnes en situation d'itinérance visible au Québec. (11 octobre 2022). Ministère de la Santé et des Services sociaux. Récupéré au https://publications.msss.gouv.qc.ca/msss/fichiers/2023/23-846-05W.pdf]_
